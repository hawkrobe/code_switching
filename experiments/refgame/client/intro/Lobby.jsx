...
import GameLobbyContainer from "meteor/empirica:core"
        ...
        <div className="core">
          <div className="game-lobby">
              <NonIdealState description={
                                 <>
          <p> Thanks for waiting, and sorry that there weren't enough other players for your game to begin in a timely fashion! </p>
          <p>  Please submit the following code so we can compensate you for your time: </p>
          <br />
              <h3> <em>3B021164</em>. </h3>
              </>}/>
          </div>
        </div>
        );
