...
```{r}
d.games <- read_csv(here('~/Downloads/Empirica Data - 2022-03-14 20-29-37/games.csv')) %>% 
  rename(gameId = `_id`)

d.players <- read_csv(here('~/Downloads/Empirica Data - 2022-03-14 20-29-37/players.csv')) %>% 
  rename(gameId = `_id`)

d.chat.raw <- read_csv(here('~/Downloads/Empirica Data - 2022-03-14 20-29-37/rounds.csv')) %>%
...
d.room_info <- read_csv(here('~/Downloads/Empirica Data - 2022-03-14 20-29-37/rounds.csv')) %>%
  filter(createdAt >= lubridate::ymd('2021-01-21')) %>%
...
```{r}
d.exit.survey <- read_csv(here('~/Downloads/Empirica Data - 2022-03-14 20-29-37/player-inputs.csv')) %>%
  filter(createdAt >= lubridate::ymd('2021-01-21')) %>%
...
```{r}
post_test.raw <- read_csv(here('~/Downloads/Empirica Data - 2022-03-14 20-29-37/player-inputs.csv')) %>%
  #filter(gameId %in% talked) %>%
